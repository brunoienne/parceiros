		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestão de Parceiros de Negócios",
									"targetURL": "#zbmparceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbmparceiros-display": {
								"semanticObject": "zbmparceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbm.parceiros",
									"url": sap.ui.require.toUrl("zbm/parceiros")
								}
							}
						}
					}
